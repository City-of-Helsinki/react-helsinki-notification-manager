...
const Qn = (i, e, t, n) => {
    ...
    pe(o[0]) && (o[0] = `react-i18next:: ${o[0]}`),
      (a = (l = i == null ? void 0 : i.services) == null ? void 0 : l.logger) != null && a.warn
        ? i.services.logger.warn(...o)
  ...
  Gn = (i, e, t = {}) =>
    !e.languages || !e.languages.length
      ? (Et(e, 'NO_LANGUAGES', 'i18n.languages were undefined or empty', {
      ...
      : e.hasLoadedNamespace(i, {
          ...
          precheck: (n, o) => {
            ...
            if (
              ...
              !o(n.isLanguageChangingTo, i)
            )
              return !1;
          },
        }),
  pe = (i) => typeof i == 'string',
  Zn = (i) => typeof i == 'object' && i !== null,
  Jn = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g,
  Yn = {
    '&amp;': '&',
    '&#38;': '&',
    '&lt;': '<',
...
const so = (i, e) => {
  ...
  en = (i, e, t, n) => i.getFixedT(e, t, n),
  ao = (i, e, t, n) => te(en(i, e, t, n), [i, e, t, n]),
  lo = (i, e = {}) => {
    var y, O, z;
    const { i18n: t } = e,
      { i18n: n, defaultNS: o } = Ut(Xi) || {},
      r = t || n || oo();
    if ((r && !r.reportNamespaces && (r.reportNamespaces = new ro()), !r)) {
      ...
      const S = (P, C) =>
          pe(C) ? C : Zn(C) && pe(C.defaultValue) ? C.defaultValue : Array.isArray(P) ? P[P.length - 1] : P,
        N = [S, {}, !1];
      return (N.t = S), (N.i18n = {}), (N.ready = !1), N;
    }
    (y = r.options.react) != null &&
      y.wait &&
      Et(
        r,
        'DEPRECATED_OPTION',
    ...
    const f = (r.isInitialized || r.initializedStoreOnce) && c.every((S) => Gn(S, r, s)),
      u = ao(r, e.lng || null, s.nsMode === 'fallback' ? c : c[0], a),
      d = () => u,
      b = () => en(r, e.lng || null, s.nsMode === 'fallback' ? c : c[0], a),
      [h, g] = le(d);
    let m = c.join();
    e.lng && (m = `${e.lng}${m}`);
    const x = so(m),
      _ = K(!0);
    J(() => {
      const { bindI18n: S, bindI18nStore: N } = s;
      (_.current = !0),
        !f &&
          !l &&
          (e.lng
      ...
      return (
        S && (r == null || r.on(S, P)),
        N && (r == null || r.store.on(N, P)),
        () => {
          (_.current = !1),
            r && (S == null || S.split(' ').forEach((C) => r.off(C, P))),
            N && r && N.split(' ').forEach((C) => r.store.off(C, P));
        }
      );
    }, [r, m]),
      J(() => {
...
function co({ i18n: i, defaultNS: e, children: t }) {
  const n = we(
    () => ({
      i18n: i,
      defaultNS: e,
...
const fo = (i) => {
    var {
      ...
      l = ce(i, ['aria-label', 'aria-hidden', 'className', 'color', 'size', 'style']);
      ...
      Object.assign(
        {
          'aria-label': e,
          'aria-hidden': t,
          className: [q.icon, q[r], n].filter((a) => a).join(' '),
          role: 'img',
  ...
  ho = (i) => {
    var {
        'aria-label': e = 'check-circle-fill',
        'aria-hidden': t = !0,
        className: n = '',
        color: o,
        size: r = Z.Small,
...
const _o = E.forwardRef((i, e) => {
    var {
        ...
        children: n,
        className: o,
        disableVisitedStyles: r = !1,
        external: s = !1,
        href: l,
        iconStart: a,
        openInNewTab: c = !1,
        openInExternalDomainAriaLabel: f,
        openInNewTabAriaLabel: u,
        style: d = {},
        size: b = oe.Medium,
        useButtonStyles: h = !1,
      } = i,
    ...
    const m = { [oe.Large]: Z.Large, [oe.Medium]: Z.Small, [oe.Small]: Z.ExtraSmall },
      x = {
        [oe.Large]: Y.verticalAlignBigIcon,
        [oe.Medium]: Y.verticalAlignMediumIcon,
        [oe.Small]: Y.verticalAlignSmallIcon,
      },
      _ = Ve(Y.link, Y[`link-${b}`], r ? Y.disableVisitedStyles : '');
    return E.createElement(
      'a',
      Object.assign(
        { className: Ve(h ? Y.button : _, o), href: l, style: d },
        c && { target: '_blank', rel: 'noopener' },
        (c || s || t) && {
          'aria-label': (() => {
            let v = t || Be(n);
            const y = c ? u || 'Avautuu uudessa välilehdessä.' : '',
              O = s ? f || 'Siirtyy toiseen sivustoon.' : '';
      ...
      a && E.createElement('span', { className: Y.iconStart, 'aria-hidden': 'true' }, a),
      h ? E.createElement('span', { className: Y.buttonLabel }, n) : n,
      s && E.createElement(po, { size: m[b], className: Ve(Y.icon, x[b]) }),
    );
  }),
...
function xo(i, e) {
  if (i === e) return i;
  let t = Pt.get(i);
  if (t) return t.forEach((o) => (o.current = e)), e;
  let n = Pt.get(e);
...
const Oo = (i = document) => {
  ...
  for (; t && 'shadowRoot' in t && !((e = t.shadowRoot) === null || e === void 0) && e.activeElement; )
...
function Eo() {
  for (var i, e, t = 0, n = '', o = arguments.length; t < o; t++)
    (i = arguments[t]) && (e = on(i)) && (n && (n += ' '), (n += e));
  return n;
}
function zo(...i) {
  let e = {
  ...
  for (let t = 1; t < i.length; t++) {
    ...
    for (let o in n) {
      let r = e[o],
        s = n[o];
      typeof r == 'function' &&
      typeof s == 'function' && // This is a lot faster than a regex.
      o[0] === 'o' &&
      o[1] === 'n' &&
      o.charCodeAt(2) /* 'A' */ >= 65 &&
      o.charCodeAt(2) /* 'Z' */ <= 90
        ? (e[o] = yo(r, s))
        : (o === 'className' || o === 'UNSAFE_className') && typeof r == 'string' && typeof s == 'string'
          ? (e[o] = Eo(r, s))
          : o === 'id' && r && s
            ? (e.id = xo(r, s))
            : (e[o] = s !== void 0 ? s : r);
...
function Ro(i) {
  let { isDisabled: e, onBlurWithin: t, onFocusWithin: n, onFocusWithinChange: o } = i,
    r = K({
      isFocusWithin: !1,
    }),
    { addGlobalListener: s, removeAllGlobalListeners: l } = Po(),
    a = te(
      (u) => {
        u.currentTarget.contains(u.target) &&
          r.current.isFocusWithin &&
          !u.currentTarget.contains(u.relatedTarget) &&
          ((r.current.isFocusWithin = !1), l(), t && t(u), o && o(!1));
      },
      [t, o, r, l],
    ),
    c = $o(a),
      ...
      (u) => {
        ...
        if (!r.current.isFocusWithin && b === Co(u.nativeEvent)) {
          ...
          s(
            ...
            'focus',
            (g) => {
              if (r.current.isFocusWithin && !Lo(h, g.target)) {
                let m = new rn(
                  'blur',
                  new d.defaultView.FocusEvent('blur', {
...
function Ao(i = {}) {
  let { style: e, isFocusable: t } = i,
    [n, o] = le(!1),
    { focusWithinProps: r } = Ro({
      isDisabled: !t,
...
function Fo(i) {
  let { children: e, elementType: t = 'div', isFocusable: n, style: o, ...r } = i,
    { visuallyHiddenProps: s } = Ao(i);
...
function un() {
  ...
  he = w.now();
  let e = ln(he);
  e && (dn(Ne.splice(0, e), (t) => t.handler()), (ge.count -= e)),
    Wt.flush(),
    Kt.flush(i ? Math.min(64, he - i) : 16.667),
    sn.flush(),
    qt.flush(),
    an.flush();
}
...
function ie(i, e, t) {
  if (p.arr(i)) {
    for (let n = 0; n < i.length; n++) e.call(t, i[n], `${n}`);
    return;
  }
  for (const n in i) i.hasOwnProperty(n) && e.call(t, i[n], n);
}
...
const Vo = (i) => {
  i.to && (hn = i.to),
    i.now && (w.now = i.now),
    i.colors !== void 0 && (ae = i.colors),
    i.skipAnimation != null && (gn = i.skipAnimation),
    i.createStringInterpolator && (Gt = i.createStringInterpolator),
    i.requestAnimationFrame && w.use(i.requestAnimationFrame),
    i.batchedUpdates && (w.batchedUpdates = i.batchedUpdates),
    i.willAdvance && (Zt = i.willAdvance),
    i.frameLoop && (w.frameLoop = i.frameLoop);
};
...
const mt = {
  ...
  start(i) {
    rt > i.priority ? (je.add(i), w.onStart(Io)) : (mn(i), w(At));
  },
  advance: At,
  sort(i) {
    if (rt) w.onFrame(() => mt.sort(i));
    else {
      const e = B.indexOf(i);
      ~e && (B.splice(e, 1), pn(i));
    }
...
const Ho = new RegExp('rgb' + pt(G, G, G)),
  Mo = new RegExp('rgba' + pt(G, G, G, G)),
  Uo = new RegExp('hsl' + pt(G, st, st)),
  Bo = new RegExp('hsla' + pt(G, st, st, G)),
  Ko = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,
  qo = /^#([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,
  Wo = /^#([0-9a-fA-F]{6})$/,
  Qo = /^#([0-9a-fA-F]{8})$/;
function Go(i) {
  let e;
  return typeof i == 'number'
    ? i >>> 0 === i && i >= 0 && i <= 4294967295
      ? i
      : null
    : (e = Wo.exec(i))
      ...
      : ae && ae[i] !== void 0
        ? ae[i]
        : (e = Ho.exec(i))
          ? ((ve(e[1]) << 24) | (ve(e[2]) << 16) | (ve(e[3]) << 8) | 255) >>> 0
          : (e = Mo.exec(i))
            ? ((ve(e[1]) << 24) | (ve(e[2]) << 16) | (ve(e[3]) << 8) | mi(e[4])) >>> 0
            : (e = Ko.exec(i))
              ...
              : (e = Qo.exec(i))
                ...
                : (e = qo.exec(i))
                  ...
                  : (e = Uo.exec(i))
                    ? (hi(gi(e[1]), tt(e[2]), tt(e[3])) | 255) >>> 0
                    : (e = Bo.exec(i))
                      ? (hi(gi(e[1]), tt(e[2]), tt(e[3])) | mi(e[4])) >>> 0
                      : null;
}
function wt(i, e, t) {
  return (
    t < 0 && (t += 1),
    t > 1 && (t -= 1),
    t < 1 / 6 ? i + (e - i) * 6 * t : t < 1 / 2 ? e : t < 2 / 3 ? i + (e - i) * (2 / 3 - t) * 6 : i
  );
}
function hi(i, e, t) {
  const n = t < 0.5 ? t * (1 + e) : t + e - t * e,
    o = 2 * t - n,
    r = wt(o, n, i + 1 / 3),
    s = wt(o, n, i),
    l = wt(o, n, i - 1 / 3);
...
const Ke = (i, e, t) => {
  ...
  if (p.str(i.output[0])) return Gt(i);
  const n = i,
    o = n.output,
    r = n.range || [0, 1],
  ...
  return (c) => {
    const f = Jo(c, r);
    return Zo(c, r[f], r[f + 1], o[f], o[f + 1], a, s, l, n.map);
  };
};
function Zo(i, e, t, n, o, r, s, l, a) {
  let c = a ? a(i) : i;
  if (c < e) {
  ...
  return n === o
    ...
    : e === t
      ? i <= e
        ? n
        : o
      : (e === -1 / 0 ? (c = -c) : t === 1 / 0 ? (c = c - e) : (c = (c - e) / (t - e)),
        (c = r(c)),
        n === -1 / 0 ? (c = -c) : o === 1 / 0 ? (c = c + n) : (c = c * (o - n) + n),
        c);
}
function Jo(i, e) {
...
const Oe = Symbol.for('FluidValue.get'),
  be = Symbol.for('FluidValue.observers'),
  U = (i) => !!(i && i[Oe]),
  I = (i) => (i && i[Oe] ? i[Oe]() : i),
  bi = (i) => i[be] || null;
function Yo(i, e) {
...
class bn {
  constructor(e) {
    if (((this[Oe] = void 0), (this[be] = void 0), !e && !(e = this.get))) throw Error('Unknown getter');
    Xo(this, e);
  }
}
const Xo = (i, e) => _n(i, Oe, e);
function Ee(i, e) {
  if (i[Oe]) {
    let t = i[be];
    t || _n(i, be, (t = /* @__PURE__ */ new Set())),
      t.has(e) || (t.add(e), i.observerAdded && i.observerAdded(t.size, e));
  }
  return e;
}
function We(i, e) {
...
const _n = (i, e, t) =>
  ...
  _i = new RegExp(`(${nt.source})(%|[a-z]+)`, 'i');
let St;
const tr = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
  ir = (i, e, t, n, o) => `rgba(${Math.round(e)}, ${Math.round(t)}, ${Math.round(n)}, ${o})`,
  vn = (i) => {
    St || (St = ae ? new RegExp(`(${Object.keys(ae).join('|')})(?!\\w)`, 'g') : /^\b$/);
    const e = i.output.map((r) => I(r).replace(er, pi).replace(St, pi)),
      t = e.map((r) => r.match(nt).map(Number)),
      o = t[0]
        .map((r, s) =>
          t.map((l) => {
    ...
    return (r) => {
      var s;
      const l = !_i.test(e[0]) && ((s = e.find((c) => _i.test(c))) == null ? void 0 : s.replace(nt, ''));
      let a = 0;
      return e[0].replace(nt, () => `${o[a++](r)}${l || ''}`).replace(tr, ir);
    };
  },
  Jt = 'react-spring: ',
  xn = (i) => {
    const e = i;
    let t = !1;
    if (typeof e != 'function') throw new TypeError(`${Jt}once requires a function parameter`);
    return (...n) => {
      t || (e(...n), (t = !0));
    };
  },
  nr = xn(console.warn);
function or() {
  nr(`${Jt}The "interpolate" function is deprecated in v9 (use "to" instead)`);
}
const rr = xn(console.warn);
function sr() {
  rr(
...
const kn = typeof window < 'u' && window.document && window.document.createElement ? Ue.useLayoutEffect : Ue.useEffect,
  Qe = Symbol.for('Animated:node'),
  ur = (i) => !!i && i[Qe] === i,
  X = (i) => i && i[Qe],
  Xt = (i, e) => To(i, Qe, e),
  _t = (i) => i && i[Qe] && i[Qe].getPayload();
class wn {
  constructor() {
...
class ze extends wn {
  ...
  setValue(e, t) {
    return (
      p.num(e) && ((this.lastPosition = e), t && ((e = Math.round(e / t) * t), this.done && (this.lastPosition = e))),
...
class vt extends wn {
  ...
  getValue(e) {
    ...
    return (
      ie(this.source, (n, o) => {
        ur(n) ? (t[o] = n.getValue(e)) : U(n) ? (t[o] = I(n)) : e || (t[o] = n);
      }),
      t
    );
  }
...
class ei extends vt {
  ...
  setValue(e) {
    ...
    return e.length == t.length ? t.map((n, o) => n.setValue(e[o])).some(Boolean) : (super.setValue(e.map(dr)), !0);
  }
}
function dr(i) {
...
const yi = Symbol.for('AnimatedComponent'),
  pr = (
    i,
    {
    ...
    const o = {
      ...
      r = (s) => {
        const l = ki(s) || 'Anonymous';
        return (
          p.str(s) ? (s = r[s] || (r[s] = xi(s, o))) : (s = s[yi] || (s[yi] = xi(s, o))),
...
const De = (i, e) => i === !0 || !!(e && i && (p.fun(i) ? i(e) : M(i).includes(e))),
  Sn = (i, e) => (p.obj(i) ? e && i[e] : i),
  Nn = (i, e) => (i.default === !0 ? i[e] : i.default ? i.default[e] : void 0),
  br = (i) => i,
  ti = (i, e = br) => {
    let t = _r;
  ...
  _r = ['config', 'onProps', 'onStart', 'onChange', 'onPause', 'onResume', 'onRest'],
  vr = {
    config: 1,
    from: 1,
    to: 1,
...
function Or(i, e, t) {
  ...
  for (const s in It) i[s] == null && (i[s] = It[s]);
  let { mass: n, frequency: o, damping: r } = i;
  return (
    p.und(o) ||
      (o < 0.01 && (o = 0.01),
      r < 0 && (r = 0),
      (i.tension = Math.pow((2 * Math.PI) / o, 2) * n),
      (i.friction = (4 * Math.PI * r * n) / o)),
    i
  );
}
function wi(i, e) {
  if (!p.und(e.decay)) i.duration = void 0;
  else {
    const t = !p.und(e.tension) || !p.und(e.friction);
    (t || !p.und(e.frequency) || !p.und(e.damping) || !p.und(e.mass)) && ((i.duration = void 0), (i.decay = void 0)),
      t && (i.frequency = void 0);
  }
}
const Si = [];
class Cr {
...
function On(i, { key: e, props: t, defaultProps: n, state: o, actions: r }) {
  return new Promise((s, l) => {
    var a;
    let c,
      f,
      u = De((a = t.cancel) != null ? a : n == null ? void 0 : n.cancel, e);
    if (u) h();
    else {
      p.und(t.pause) || (o.paused = De(t.pause, e));
      let g = n == null ? void 0 : n.pause;
      g !== !0 && (g = o.paused || De(g, e)),
        (c = de(t.delay || 0, e)),
        g ? (o.resumeQueue.add(b), r.pause()) : (r.resume(), b());
    }
    function d() {
...
function En(i, e, t, n) {
  const { callId: o, parentId: r, onRest: s } = e,
    { asyncTo: l, promise: a } = t;
  return !r && i === l && !e.reset
    ? a
    : (t.promise = (async () => {
        (t.asyncId = o), (t.asyncTo = i);
        const c = ti(e, (m, x) => (x === 'onRest' ? void 0 : m));
        let f, u;
        const d = new Promise((m, x) => ((f = m), (u = x))),
          b = (m) => {
            const x = (o <= (t.cancelId || 0) && Le(n)) || (o !== t.asyncId && Q(n, !1));
            if (x) throw ((m.result = x), u(m), m);
          },
          h = (m, x) => {
            const _ = new Ni(),
              v = new Li();
            return (async () => {
              if (ne.skipAnimation) throw (Ze(t), (v.result = Q(n, !1)), u(v), v);
              b(_);
              const y = p.obj(m)
                ? A({}, m)
                : A({}, x, {
        ...
        let g;
        if (ne.skipAnimation) return Ze(t), Q(n, !1);
        try {
          let m;
          p.arr(i)
            ? (m = (async (x) => {
                for (const _ of x) await h(_);
              })(i))
            : (m = Promise.resolve(i(h, n.stop.bind(n)))),
            await Promise.all([m.then(f), d]),
            (g = Q(n.get(), !0, !1));
        } catch (m) {
          if (m instanceof Ni) g = m.result;
          else if (m instanceof Li) g = m.result;
          else throw m;
        } finally {
...
function Ze(i, e) {
  Ie(i.timeouts, (t) => t.cancel()),
    i.pauseQueue.clear(),
    i.resumeQueue.clear(),
    (i.asyncId = i.asyncTo = i.promise = void 0),
    e && (i.cancelId = e);
}
...
const jt = (i) => i instanceof ni;
let Er = 1;
class ni extends bn {
  constructor(...e) {
    super(...e), (this.id = Er++), (this.key = void 0), (this._priority = 0);
  }
  get priority() {
...
const _e = Symbol.for('SpringPhase'),
  zn = 1,
  Pn = 2,
  $n = 4,
  Nt = (i) => (i[_e] & zn) > 0,
  se = (i) => (i[_e] & Pn) > 0,
  $e = (i) => (i[_e] & $n) > 0,
  Oi = (i, e) => (e ? (i[_e] |= Pn | zn) : (i[_e] &= -3)),
  Ci = (i, e) => (e ? (i[_e] |= $n) : (i[_e] &= -5));
class zr extends ni {
  constructor(e, t) {
    if (
      (super(),
  ...
  advance(e) {
    ...
    let { config: r, toValues: s } = o;
    const l = _t(o.to);
    !l && U(o.to) && (s = M(I(o.to))),
      o.values.forEach((f, u) => {
        if (f.done) return;
        ...
        if (!b) {
          ...
          const m = o.fromValues[u],
            x = f.v0 != null ? f.v0 : (f.v0 = p.arr(r.velocity) ? r.velocity[u] : r.velocity);
          let _;
          if (p.und(r.duration))
            if (r.decay) {
              const v = r.decay === !0 ? 0.998 : r.decay,
                y = Math.exp(-(1 - v) * g);
              (h = m + (x / (1 - v)) * (1 - y)), (b = Math.abs(f.lastPosition - h) < 0.1), (_ = x * y);
            } else {
              _ = f.lastVelocity == null ? x : f.lastVelocity;
              const v = r.precision || (m == d ? 5e-3 : Math.min(1, Math.abs(d - m) * 1e-3)),
                y = r.restVelocity || v / 10,
                O = r.clamp ? 0 : r.bounce,
                z = !p.und(O),
                S = m == d ? f.v0 > 0 : m < d;
              let N,
                P = !1;
            ...
            r.duration > 0 &&
              (this._memoizedDuration !== r.duration &&
                ((this._memoizedDuration = r.duration),
                f.durationProgress > 0 &&
                  ((f.elapsedTime = r.duration * f.durationProgress), (g = f.elapsedTime += e))),
              (v = (r.progress || 0) + g / this._memoizedDuration),
              (v = v > 1 ? 1 : v < 0 ? 0 : v),
              (f.durationProgress = v)),
              (h = m + r.easing(v) * (d - m)),
              (_ = (h - f.lastPosition) / e),
              (b = v == 1);
          }
  ...
  stop(e) {
    ...
    return (
      this._focus(this.get()), Ze(this._state, e && this._lastCallId), w.batchedUpdates(() => this._stop(t, e)), this
    );
  }
  reset() {
    this._update({
  ...
  _prepareNode(e) {
    ...
    return (
      Nt(this) || (e.reverse && ([n, o] = [o, n]), (o = I(o)), p.und(o) ? X(this) || this._set(n) : this._set(o)), r
    );
  }
  _update(e, t) {
    let n = A({}, e);
    const { key: o, defaultProps: r } = this;
    n.default &&
      Object.assign(
        r,
        ti(n, (a, c) => (/^on/.test(c) ? Sn(a, o) : a)),
      ),
      zi(this, n, 'onProps'),
    ...
    return On(++this._lastCallId, {
      ...
      actions: {
        pause: () => {
          $e(this) || (Ci(this, !0), Te(l.pauseQueue), Ae(this, 'onPause', Q(this, Re(this, this.animation.to)), this));
        },
        resume: () => {
          $e(this) &&
            (Ci(this, !1),
            se(this) && this._resume(),
            Te(l.resumeQueue),
            Ae(this, 'onResume', Q(this, Re(this, this.animation.to)), this));
        },
  ...
  _merge(e, t, n) {
    if (t.cancel) return this.stop(!0), n(Le(this));
    const o = !p.und(e.to),
      r = !p.und(e.from);
    if (o || r)
      if (t.callId > this._lastToId) this._lastToId = t.callId;
      else return n(Le(this));
    const { key: s, defaultProps: l, animation: a } = this,
      { to: c, from: f } = a;
    let { to: u = c, from: d = f } = e;
    ...
    const g = Vt(t.to),
      { config: m } = a,
      { decay: x, velocity: _ } = m;
    (o || r) && (m.velocity = 0),
      t.config && !g && Or(m, de(t.config, s), t.config !== l.config ? de(l.config, s) : void 0);
    let v = X(this);
    if (!v || p.und(u)) return n(Q(this, !0));
    const y = p.und(t.reset) ? r && !t.default : !p.und(d) && De(t.reset, s),
      O = y ? d : this.get(),
      z = Ge(u),
      S = p.num(z) || p.arr(z) || bt(z),
      N = !g && (!S || De(l.immediate || t.immediate, s));
    if (h) {
      const $ = Tt(u);
      if ($ !== v.constructor)
        if (N) v = this._set(z);
    ...
    if (!C) {
      const $ = y || (!Nt(this) && b);
      (h || $) && ((R = re(Ge(O), z)), (C = !R)),
        ((!re(a.immediate, N) && !N) || !re(m.decay, x) || !re(m.velocity, _)) && (C = !0);
    }
    if (
      (R && se(this) && (a.changed && !y ? (C = !0) : C || this._stop(c)),
      !g &&
        ((C || U(c)) && ((a.values = v.getPayload()), (a.toValues = U(u) ? null : P == Ce ? [1] : M(z))),
        a.immediate != N && ((a.immediate = N), !N && !y && this._set(c)),
        C))
    ) {
      const { onRest: $ } = a;
      L($r, (F) => zi(this, t, F));
      const W = Q(this, Re(this, c));
      Te(this._pendingCalls, W),
    ...
    y && this._set(O),
      g ? n(En(t.to, t, this._state, this)) : C ? this._start() : se(this) && !h ? this._pendingCalls.add(n) : n(Cn(O));
  }
  _focus(e) {
  ...
  _attach() {
    let e = 0;
    const { to: t } = this.animation;
    U(t) && (Ee(t, this), jt(t) && (e = t.priority + 1)), (this.priority = e);
  }
  _detach() {
  ...
  _set(e, t = !0) {
    ...
    if (!p.und(n)) {
      ...
      if (!o || !re(n, o.getValue())) {
        const r = Tt(n);
        !o || o.constructor != r ? Xt(this, r.create(n)) : o.setValue(n),
          o &&
            w.batchedUpdates(() => {
              this._onChange(n, t);
            });
  ...
  _onChange(e, t) {
    t || (this._onStart(), de(this.animation.onChange, e, this)),
      de(this.defaultProps.onChange, e, this),
      super._onChange(e, t);
  }
  _start() {
    const e = this.animation;
    X(this).reset(I(e.to)),
      ...
      se(this) || (Oi(this, !0), $e(this) || this._resume());
  }
  _resume() {
...
const $r = ['onStart', 'onRest', 'onChange', 'onPause', 'onResume'];
function zi(i, e, t) {
...
const Rr = ['onStart', 'onChange', 'onRest'];
let Ar = 1;
class Fr {
  constructor(e, t) {
    (this.id = Ar++),
  ...
  start(e) {
    let { queue: t } = this;
    return e ? (t = M(e).map(Je)) : (this.queue = []), this._flush ? this._flush(this, t) : (In(this, t), Dt(this, t));
  }
  stop(e, t) {
    if ((e !== !!e && (t = e), t)) {
      const n = this.springs;
      L(M(t), (o) => n[o].stop(!!e));
    } else Ze(this._state, this._lastAsyncId), this.each((n) => n.stop(!!e));
    return this;
  }
  pause(e) {
    if (p.und(e))
...
async function An(i, e, t) {
  const { keys: n, to: o, from: r, loop: s, onRest: l, onResolve: a } = e,
  ...
  f
    ...
    : L(Rr, (g) => {
        ...
        if (p.fun(m)) {
          const x = i._events[g];
          (e[g] = ({ finished: _, cancelled: v }) => {
            const y = x.get(m);
            y
              ? (_ || (y.finished = !1), v && (y.cancelled = !0))
              : x.set(m, {
                  value: null,
                  finished: _ || !1,
                  cancelled: v || !1,
  ...
  const u = i._state;
  e.pause === !u.paused
    ? ((u.paused = e.pause), Te(e.pause ? u.pauseQueue : u.resumeQueue))
    : u.paused && (e.pause = !0);
  const d = (n || Object.keys(i.springs)).map((g) => i.springs[g].start(e)),
    b = e.cancel === !0 || Nn(e, 'cancel') === !0;
  (f || (b && u.asyncId)) &&
    d.push(
      On(++i._lastAsyncId, {
        props: e,
        ...
        actions: {
          ...
          resume: Rt,
          start(g, m) {
            b ? (Ze(u, i._lastAsyncId), m(Le(i))) : ((g.onRest = l), m(En(f, g, u, i)));
          },
        },
      }),
    ),
...
function Tr(i, e) {
  ...
  var t = {},
    ...
    o,
    r;
  for (r = 0; r < n.length; r++) (o = n[r]), !(e.indexOf(o) >= 0) && (t[o] = i[o]);
  return t;
}
const Vr = ['children'],
  xt = (i) => {
...
function Dr(i, e, t) {
  const n = p.fun(e) && e;
  n && !t && (t = []);
  const o = we(() => (n || arguments.length == 3 ? jr() : void 0), []),
    r = K(0),
    s = yn(),
    l = we(
      () => ({
        ...
        flush(x, _) {
          const v = Pi(x, _);
          return r.current > 0 && !l.queue.length && !Object.keys(v).some((O) => !x.springs[O])
            ? Dt(x, _)
            : new Promise((O) => {
                Fn(x, v),
                  l.queue.push(() => {
  ...
  function u(x, _) {
    for (let v = x; v < _; v++) {
      const y = a.current[v] || (a.current[v] = new Fr(null, l.flush)),
        O = n ? n(v, y) : e[v];
      O && (c[v] = Pr(O));
    }
  }
  const d = a.current.map((x, _) => Pi(x, c[_])),
    b = Ut(xt),
    h = vi(b),
    g = b !== h && yr(b);
  kn(() => {
    ...
    x.length && ((l.queue = []), L(x, (_) => _())),
      L(a.current, (_, v) => {
        ...
        const y = c[v];
        y && (wr(_, y.ref), _.ref ? _.queue.push(y) : _.start(y));
      });
  }),
    Yt(() => () => {
...
class Hr extends ni {
  ...
  advance(e) {
    const t = this._get(),
      n = this.get();
    re(t, n) || (X(this).setValue(t), this._onChange(t, this.idle)), !this.idle && Ai(this._active) && Lt(this);
  }
  _get() {
  ...
  _attach() {
    let e = 1;
    L(M(this.source), (t) => {
      U(t) && Ee(t, this), jt(t) && (t.idle || this._active.add(t), (e = Math.max(e, t.priority + 1)));
    }),
      (this.priority = e),
      this._start();
  }
  ...
  eventObserved(e) {
    e.type == 'change'
      ...
      : e.type == 'idle'
        ...
        : e.type == 'priority' &&
          (this.priority = M(this.source).reduce((t, n) => Math.max(t, (jt(n) ? n.priority : 0) + 1), 0));
  }
}
function Mr(i) {
  return i.idle !== !1;
...
function Ai(i) {
  return !i.size || Array.from(i).every(Mr);
}
function Lt(i) {
  i.idle ||
    ((i.idle = !0),
...
const Ur = ['style', 'children', 'scrollTop', 'scrollLeft'],
  jn = /^--/;
function Br(i, e) {
  return e == null || typeof e == 'boolean' || e === ''
    ? ''
    : typeof e == 'number' && e !== 0 && !jn.test(i) && !(He.hasOwnProperty(i) && He[i])
      ? e + 'px'
      : ('' + e).trim();
}
const Fi = {};
function Kr(i, e) {
  if (!i.nodeType || !i.setAttribute) return !1;
  const t = i.nodeName === 'filter' || (i.parentNode && i.parentNode.nodeName === 'filter'),
    n = e,
    { style: o, children: r, scrollTop: s, scrollLeft: l } = n,
    a = oi(n, Ur),
    c = Object.values(a),
    f = Object.keys(a).map((u) =>
      t || i.hasAttribute(u) ? u : Fi[u] || (Fi[u] = u.replace(/([A-Z])/g, (d) => '-' + d.toLowerCase())),
    );
  r !== void 0 && (i.textContent = r);
  for (let u in o)
    if (o.hasOwnProperty(u)) {
      const d = Br(u, o[u]);
      jn.test(u) ? i.style.setProperty(u, d) : (i.style[u] = d);
    }
  f.forEach((u, d) => {
    i.setAttribute(u, c[d]);
  }),
    s !== void 0 && (i.scrollTop = s),
    l !== void 0 && (i.scrollLeft = l);
}
let He = {
...
const qr = (i, e) => i + e.charAt(0).toUpperCase() + e.substring(1),
  Wr = ['Webkit', 'Ms', 'Moz', 'O'];
He = Object.keys(He).reduce((i, e) => (Wr.forEach((t) => (i[qr(t, e)] = i[e])), i), He);
const Qr = ['x', 'y', 'z'],
  Gr = /^(matrix|translate|scale|rotate|skew)/,
  Zr = /^(translate)/,
  Jr = /^(rotate|skew)/,
  Ot = (i, e) => (p.num(i) && i !== 0 ? i + e : i),
  ot = (i, e) => (p.arr(i) ? i.every((t) => ot(t, e)) : p.num(i) ? i === e : parseFloat(i) === e);
class Yr extends vt {
  constructor(e) {
    let { x: t, y: n, z: o } = e,
      r = oi(e, Qr);
    ...
    (t || n || o) &&
      (s.push([t || 0, n || 0, o || 0]),
      l.push((a) => [`translate3d(${a.map((c) => Ot(c, 'px')).join(',')})`, ot(a, 0)])),
      ie(r, (a, c) => {
        if (c === 'transform') s.push([a || '']), l.push((f) => [f, f === '']);
        else if (Gr.test(c)) {
          if ((delete r[c], p.und(a))) return;
          const f = Zr.test(c) ? 'px' : Jr.test(c) ? 'deg' : '';
          s.push(M(a)),
            l.push(
              c === 'rotate3d'
                ? ([u, d, b, h]) => [`rotate3d(${u},${d},${b},${Ot(h, f)})`, ot(h, 0)]
                : (u) => [`${c}(${u.map((d) => Ot(d, f)).join(',')})`, ot(u, c.startsWith('scale') ? 1 : 0)],
            );
        }
      }),
      s.length && (r.transform = new Xr(s, l)),
      super(r);
  }
}
class Xr extends bn {
  ...
  _get() {
    ...
    return (
      L(this.inputs, (n, o) => {
        const r = I(n[0]),
          [s, l] = this.transforms[o](p.arr(r) ? r : n.map(I));
        (e += ' ' + s), (t = t && l);
      }),
      t ? 'none' : e
    );
...
const is = pr(es, {
    ...
    createAnimatedStyle: (i) => new Yr(i),
    getComponentProps: (i) => oi(i, ts),
  }),
  Ti = is.animated;
var me;
(function (i) {
...
const ns = { info: uo, success: ho, error: mo, alert: fo },
  Vi = ({ visuallyHidden: i, children: e }) => (i ? E.createElement(Fo, null, e) : e),
  os = E.forwardRef((i, e) => {
    var {
        autoClose: t = !1,
        autoCloseDuration: n,
        ...
        children: r,
        className: s = '',
        closeAnimationDuration: l = 85,
        closeButtonLabelText: a,
        dismissible: c = !1,
        displayAutoCloseProgress: f = !0,
        invisible: u = !1,
        label: d,
        notificationAriaLabel: b = 'Notification',
        position: h = 'inline',
        onClose: g = () => null,
        size: m = me.Medium,
        style: x,
    ...
    O &&
      m === me.Large &&
      (console.warn(`Size '${m}' is only allowed for inline positioned notifications`), (m = me.Medium)),
      !O &&
        t &&
        (console.warn("The 'autoClose' property is not allowed for inline positioned notifications"), (t = !1));
    const [z, S] = le(!0),
      N = te(() => {
        S(!1), setTimeout(() => g(), l);
      }, [g, l]),
    ...
    const C = ns[_],
      R = O
        ? ((T) => {
            ...
            return {
              from: {
                transform: `translate3d(${fe ? '-50%' : '0'}, ${T.includes('top') ? '-' : ''}32px, 0)`,
                opacity: 0.66,
              },
              to: { transform: `translate3d(${fe ? '-50%' : '0'}, 0, 0)`, opacity: 1 },
              config: { friction: 30, tension: 300 },
            };
          })(h)
        : {},
      $ = { from: { opacity: 1 }, to: { opacity: 0 }, config: { duration: l } },
      W = f
        ? /* @__PURE__ */ ((T) => ({
    ...
    return E.createElement(
      ...
      E.createElement(
        Ti.section,
        Object.assign({}, y, {
          style: Object.assign(Object.assign({}, F), x),
          className: Ve(H[h], H.notification, H[m], H[_], t && H.noBorder, o && H.boxShadow, s),
          'aria-label': b,
          role: O || u ? 'alert' : void 0,
        }),
        t && E.createElement(Ti.div, { style: j, className: H.autoClose }),
        E.createElement(
          'div',
          { className: H.content, ref: e },
          d &&
            E.createElement(
              'div',
              Object.assign({ className: H.label }, O || u ? {} : { role: 'heading', 'aria-level': v }),
              E.createElement(C, { className: H.icon }),
              E.createElement(Vi, { visuallyHidden: m === me.Small }, d),
            ),
          r && E.createElement('div', { className: H.body }, r),
        ),
        c &&
          E.createElement(
            'button',
            { className: Ve(H.close, H[_]), type: 'button', title: a, 'aria-label': a, onClick: N },
  ...
  rs = (i) => {
    const { t: e } = lo('hns'),
      { notifications: t, onClose: n } = i,
      o = e('close'),
      r = e('notificationAriaLabel'),
      s = e('openExternalDomainAriaLabel'),
      l = e('openNewTabAriaLabel');
    return /* @__PURE__ */ ke(li, {
      children: t.map((a) =>
        /* @__PURE__ */ ke(
          'div',
          {
            className: 'notification-container',
            children: /* @__PURE__ */ ci(os, {
              type: a.level,
              label: a.title,
              dismissible: !0,
  ...
  as = /###/g,
  ji = (i) => (i && i.indexOf('###') > -1 ? i.replace(as, '.') : i),
  Di = (i) => !i || k(i),
  Me = (i, e, t) => {
  ...
  Hi = (i, e, t) => {
    ...
    for (; l.obj === void 0 && s.length; )
      (r = `${s[s.length - 1]}.${r}`),
        ...
        (l = Me(i, s, Object)),
        l != null && l.obj && typeof l.obj[`${l.k}.${r}`] < 'u' && (l.obj = void 0);
    l.obj[`${l.k}.${r}`] = t;
  },
  ls = (i, e, t, n) => {
    const { obj: o, k: r } = Me(i, e, Object);
    (o[r] = o[r] || []), o[r].push(t);
  },
  ft = (i, e) => {
    const { obj: t, k: n } = Me(i, e);
  ...
  Dn = (i, e, t) => {
    for (const n in e)
      n !== '__proto__' &&
        n !== 'constructor' &&
        (n in i
          ? k(i[n]) || i[n] instanceof String || k(e[n]) || e[n] instanceof String
            ? t && (i[n] = e[n])
            : Dn(i[n], e[n], t)
          : (i[n] = e[n]));
    return i;
...
const hs = [' ', ',', '?', '!', ';'],
    ...
    for (let r = 0; r < n.length; ) {
      ...
      for (let a = r; a < n.length; ++a)
        if ((a !== r && (l += t), (l += n[a]), (s = o[l]), s !== void 0)) {
          if (['string', 'number', 'boolean'].indexOf(typeof s) > -1 && a < n.length - 1) continue;
          r += a - r + 1;
          break;
        }
      o = s;
  ...
  ut = (i) => (i == null ? void 0 : i.replace('_', '-')),
  ps = {
    type: 'logger',
    log(i) {
      this.output('log', i);
  ...
  emit(e) {
    ...
    this.observers[e] &&
      Array.from(this.observers[e].entries()).forEach((s) => {
        let [l, a] = s;
        for (let c = 0; c < a; c++) l(...n);
      }),
      this.observers['*'] &&
        Array.from(this.observers['*'].entries()).forEach((s) => {
          let [l, a] = s;
          for (let c = 0; c < a; c++) l.apply(l, [e, ...n]);
        });
  }
}
class Mi extends yt {
  ...
  getResource(e, t, n) {
    ...
    const r = o.keySeparator !== void 0 ? o.keySeparator : this.options.keySeparator,
      s = o.ignoreJSONStructure !== void 0 ? o.ignoreJSONStructure : this.options.ignoreJSONStructure;
    let l;
    e.indexOf('.') > -1
      ? (l = e.split('.'))
      : ((l = [e, t]), n && (Array.isArray(n) ? l.push(...n) : k(n) && r ? l.push(...n.split(r)) : l.push(n)));
    const a = ft(this.data, l);
    return (
      !a && !t && !n && e.indexOf('.') > -1 && ((e = l[0]), (t = l[1]), (n = l.slice(2).join('.'))),
      a || !s || !k(n) ? a : Ht((f = (c = this.data) == null ? void 0 : c[e]) == null ? void 0 : f[t], n, r)
    );
  }
  addResource(e, t, n, o) {
    let r =
    ...
    let l = [e, t];
    n && (l = l.concat(s ? n.split(s) : n)),
      e.indexOf('.') > -1 && ((l = e.split('.')), (o = t), (t = l[1])),
...
const Ui = {},
  Bi = (i) => !k(i) && typeof i != 'boolean' && typeof i != 'number';
class ht extends yt {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(),
      ...
      (this.options = t),
      this.options.keySeparator === void 0 && (this.options.keySeparator = '.'),
      (this.logger = ee.create('translator'));
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  translate(e, t, n) {
    ...
    const o = t.returnDetails !== void 0 ? t.returnDetails : this.options.returnDetails,
      ...
      { key: s, namespaces: l } = this.extractFromKey(e[e.length - 1], t),
      a = l[l.length - 1],
    ...
    const b = (u == null ? void 0 : u.usedKey) || s,
      h = (u == null ? void 0 : u.exactUsedKey) || s,
      ...
      _ = t.count !== void 0 && !k(t.count),
      v = ht.hasDefaultValue(t),
      y = _ ? this.pluralResolver.getSuffix(c, t.count, t) : '',
      O =
        t.ordinal && _
          ? this.pluralResolver.getSuffix(c, t.count, {
              ordinal: !1,
            })
          : '',
      z = _ && !t.ordinal && t.count === 0,
      S =
    ...
    if (x && N && P && g.indexOf(C) < 0 && !(k(m) && Array.isArray(N))) {
    ...
    } else if (x && k(m) && Array.isArray(d)) (d = d.join(m)), d && (d = this.extendTranslation(d, e, t, n));
    else {
      let R = !1,
        $ = !1;
      !this.isValidLookup(d) && v && ((R = !0), (d = S)), this.isValidLookup(d) || (($ = !0), (d = s));
      const F = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && $ ? void 0 : d,
        j = v && S !== d && this.options.updateMissing;
      if ($ || R || j) {
        ...
        if (this.options.saveMissingTo === 'fallback' && fe && fe[0]) for (let D = 0; D < fe.length; D++) T.push(fe[D]);
        else
          this.options.saveMissingTo === 'all'
            ? (T = this.languageUtils.toResolveHierarchy(t.lng || this.language))
            : T.push(t.lng || this.language);
        const ri = (D, ue, Pe) => {
          var ai;
          const si = v && Pe !== d ? Pe : F;
          this.options.missingKeyHandler
            ? this.options.missingKeyHandler(D, a, ue, si, j, t)
            : (ai = this.backendConnector) != null &&
              ai.saveMissing &&
              this.backendConnector.saveMissing(D, a, ue, si, j, t),
            this.emit('missingKey', D, a, ue, d);
        };
      ...
      (d = this.extendTranslation(d, e, t, u, n)),
        $ && d === s && this.options.appendNamespaceToMissingKey && (d = `${a}:${s}`),
        ($ || R) &&
  ...
  extendTranslation(e, t, n, o, r) {
    ...
    if ((c = this.i18nFormat) != null && c.parse)
      ...
      const u =
        k(e) &&
        (((f = n == null ? void 0 : n.interpolation) == null ? void 0 : f.skipOnVariables) !== void 0
      ...
      if (
        ...
        (e = this.interpolator.interpolate(e, b, n.lng || this.language || o.usedLng, n)),
        u)
      ) {
        const h = e.match(this.interpolator.nestingRegexp),
          g = h && h.length;
      ...
      !n.lng && o && o.res && (n.lng = this.language || o.usedLng),
        n.nest !== !1 &&
          (e = this.interpolator.nest(
            e,
            function () {
              for (var h = arguments.length, g = new Array(h), m = 0; m < h; m++) g[m] = arguments[m];
              return (r == null ? void 0 : r[0]) === g[0] && !n.context
                ? (s.logger.warn(`It seems you are nesting recursively key: ${g[0]} in key: ${t[0]}`), null)
                : s.translate(...g, t);
            },
            n,
          )),
  ...
  resolve(e) {
    ...
    return (
      ...
      e.forEach((a) => {
        ...
        const c = this.extractFromKey(a, t),
          f = c.key;
        o = f;
        let u = c.namespaces;
        this.options.fallbackNS && (u = u.concat(this.options.fallbackNS));
        const d = t.count !== void 0 && !k(t.count),
          b = d && !t.ordinal && t.count === 0,
          h = t.context !== void 0 && (k(t.context) || typeof t.context == 'number') && t.context !== '',
        ...
        u.forEach((m) => {
          ...
          this.isValidLookup(n) ||
            ...
            !Ui[`${g[0]}-${m}`] &&
              ...
              !((_ = this.utils) != null && _.hasLoadedNamespace(l)) &&
              ((Ui[`${g[0]}-${m}`] = !0),
              this.logger.warn(
                `key "${o}" for languages "${g.join(', ')}" won't get resolved as namespace "${l}" was not yet loaded`,
            ...
            g.forEach((v) => {
              ...
              s = v;
              const y = [f];
              if ((z = this.i18nFormat) != null && z.addLookupKeys) this.i18nFormat.addLookupKeys(y, f, v, m, t);
              else {
                let S;
                ...
                if (
                  (d &&
                    (y.push(f + S),
                    t.ordinal && S.indexOf(P) === 0 && y.push(f + S.replace(P, this.options.pluralSeparator)),
                    b && y.push(f + N)),
                  h)
                ) {
                  ...
                  y.push(C),
                    d &&
                      (y.push(C + S),
                      t.ordinal && S.indexOf(P) === 0 && y.push(C + S.replace(P, this.options.pluralSeparator)),
                      b && y.push(C + N));
                }
              }
              let O;
              for (; (O = y.pop()); ) this.isValidLookup(n) || ((r = O), (n = this.getResource(v, m, O, t)));
            }));
        });
      }),
      {
...
class Ki {
  constructor(e) {
    (this.options = e),
      ...
      (this.logger = ee.create('languageUtils'));
  }
  ...
  formatLanguageCode(e) {
    if (k(e) && e.indexOf('-') > -1) {
      ...
      return (
        t && this.options.lowerCaseLng && (t = t.toLowerCase()), t || (this.options.lowerCaseLng ? e.toLowerCase() : e)
      );
    }
        ...
        e.forEach((n) => {
          ...
          t = this.options.supportedLngs.find((r) => {
            ...
            if (
              ...
              ((r.indexOf('-') > 0 && o.indexOf('-') < 0 && r.substring(0, r.indexOf('-')) === o) ||
  ...
  toResolveHierarchy(e, t) {
    ...
    return (
      k(e) && (e.indexOf('-') > -1 || e.indexOf('_') > -1)
        ...
        : k(e) && r(this.formatLanguageCode(e)),
      n.forEach((s) => {
...
class bs {
  constructor(e) {
    ...
    (this.languageUtils = e),
      (this.options = t),
      (this.logger = ee.create('pluralResolver')),
  ...
  getRule(e) {
    ...
    try {
      ...
      if (!Intl) return this.logger.error('No Intl support, please use an Intl polyfill!'), Wi;
  ...
  getSuffixes(e) {
    ...
    return (
      ...
      n
        ? n
            .resolvedOptions()
            .pluralCategories.sort((o, r) => qi[o] - qi[r])
            .map((o) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ''}${o}`)
        : []
    );
  }
  getSuffix(e, t) {
    ...
    return o
      ? `${this.options.prepend}${n.ordinal ? `ordinal${this.options.prepend}` : ''}${o.select(t)}`
...
class _s {
  constructor() {
    var t;
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    (this.logger = ee.create('interpolator')),
      (this.options = e),
      (this.format = ((t = e == null ? void 0 : e.interpolation) == null ? void 0 : t.format) || ((n) => n)),
      this.init(e);
  }
  init() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    (this.escape = t !== void 0 ? t : us),
      (this.escapeValue = n !== void 0 ? n : !0),
      (this.useRawValueToEscape = o !== void 0 ? o : !1),
      (this.prefix = r ? xe(r) : s || '{{'),
      (this.suffix = l ? xe(l) : a || '}}'),
      (this.formatSeparator = c || ','),
      (this.unescapePrefix = f ? '' : u || '-'),
      (this.unescapeSuffix = this.unescapePrefix ? '' : f || ''),
      (this.nestingPrefix = d ? xe(d) : b || xe('$t(')),
      (this.nestingSuffix = h ? xe(h) : g || xe(')')),
  ...
  interpolate(e, t, n, o) {
    ...
    this.resetRegExp();
    const f = (o == null ? void 0 : o.missingInterpolationHandler) || this.options.missingInterpolationHandler,
      u =
        ((b = o == null ? void 0 : o.interpolation) == null ? void 0 : b.skipOnVariables) !== void 0
        ...
        for (l = 0; (r = h.regex.exec(e)); ) {
          ...
          if (((s = c(g)), s === void 0))
            if (typeof f == 'function') {
              ...
              s = r[0];
              continue;
            } else this.logger.warn(`missed to pass in variable ${g} for interpolating ${e}`), (s = '');
          else !k(s) && !this.useRawValueToEscape && (s = Ii(s));
          const m = h.safeValue(s);
          if (
            ((e = e.replace(r[0], m)),
            u ? ((h.regex.lastIndex += s.length), (h.regex.lastIndex -= r[0].length)) : (h.regex.lastIndex = 0),
            l++,
            l >= this.maxReplaces)
          )
            break;
  ...
  nest(e, t) {
    ...
    for (; (o = this.nestingRegexp.exec(e)); ) {
      ...
      (s = {
        ...
        (s = s.replace && !k(s.replace) ? s.replace : s),
      ...
      k(r) || (r = Ii(r)),
        r || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${e}`), (r = '')),
        c &&
          (r = a.reduce(
            (f, u) =>
              this.format(f, u, n.lng, {
                ...n,
...
class xs {
  constructor() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    (this.logger = ee.create('formatter')),
      (this.options = e),
      (this.formats = {
        number: ye((t, n) => {
  ...
  format(e, t, n) {
    ...
    return r.reduce((l, a) => {
      var u;
      const { formatName: c, formatOptions: f } = vs(a);
      if (this.formats[c]) {
        let d = l;
        try {
          const b = ((u = o == null ? void 0 : o.formatParams) == null ? void 0 : u[o.interpolationkey]) || {},
            h = b.locale || b.lng || o.locale || o.lng || n;
...
class ks extends yt {
  constructor(e, t, n) {
    ...
    super(),
      ...
      (this.options = o),
      (this.logger = ee.create('backendConnector')),
      (this.waitingReads = []),
      ...
      (this.state = {}),
      (this.queue = []),
      (s = (r = this.backend) == null ? void 0 : r.init) == null || s.call(r, n, o.backend, o);
  }
  queueLoad(e, t, n, o) {
    const r = {},
      s = {},
    ...
    return (
      e.forEach((c) => {
        ...
        t.forEach((u) => {
          const d = `${c}|${u}`;
          !n.reload && this.store.hasResourceBundle(c, u)
            ? (this.state[d] = 2)
            : this.state[d] < 0 ||
              (this.state[d] === 1
                ? s[d] === void 0 && (s[d] = !0)
  ...
  loadOne(e) {
    ...
    this.read(o, r, 'read', void 0, void 0, (s, l) => {
      s && this.logger.warn(`${t}loading namespace ${r} for language ${o} failed`, s),
        !s && l && this.logger.log(`${t}loaded namespace ${r} for language ${o}`, l),
        this.loaded(e, s, l);
    });
  }
  saveMissing(e, t, n, o, r) {
    ...
    if (
      (c = (a = this.services) == null ? void 0 : a.utils) != null &&
      c.hasLoadedNamespace &&
      !((u = (f = this.services) == null ? void 0 : f.utils) != null && u.hasLoadedNamespace(t))
    ) {
      this.logger.warn(
    ...
    if (!(n == null || n === '')) {
      if ((d = this.backend) != null && d.create) {
        ...
        if (h.length < 6)
          try {
            let g;
            h.length === 5 ? (g = h(e, t, n, o, b)) : (g = h(e, t, n, o)),
              g && typeof g.then == 'function' ? g.then((m) => l(null, m)).catch(l) : l(null, g);
          } catch (g) {
            l(g);
          }
        else h(e, t, n, o, l, b);
...
const Gi = () => ({
    ...
    overloadTranslationOptionHandler: (i) => {
      ...
      if (
        ...
        k(i[1]) && (e.defaultValue = i[1]),
        k(i[2]) && (e.tDescription = i[2]),
  ...
  Zi = (i) => {
    ...
    return (
      k(i.ns) && (i.ns = [i.ns]),
      k(i.fallbackLng) && (i.fallbackLng = [i.fallbackLng]),
      k(i.fallbackNS) && (i.fallbackNS = [i.fallbackNS]),
      ((t = (e = i.supportedLngs) == null ? void 0 : e.indexOf) == null ? void 0 : t.call(e, 'cimode')) < 0 &&
...
class Ye extends yt {
  ...
  init() {
    ...
    (this.isInitializing = !0),
      ...
      t.defaultNS == null &&
        t.ns &&
        (k(t.ns) ? (t.defaultNS = t.ns) : t.ns.indexOf('translation') < 0 && (t.defaultNS = t.ns[0]));
    const o = Gi();
    (this.options = {
      ...o,
      ...this.options,
    ...
    if (!this.options.isClone) {
      ...
      (d.logger = ee),
        ...
        (d.interpolator = new _s(this.options)),
        (d.utils = {
          hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
        }),
        (d.backendConnector = new ks(r(this.modules.backend), d.resourceStore, d, this.options)),
        d.backendConnector.on('*', function (b) {
          for (var h = arguments.length, g = new Array(h > 1 ? h - 1 : 0), m = 1; m < h; m++) g[m - 1] = arguments[m];
          e.emit(b, ...g);
        }),
        ...
        this.modules.i18nFormat &&
          ((d.i18nFormat = r(this.modules.i18nFormat)), d.i18nFormat.init && d.i18nFormat.init(this)),
  ...
  loadResources(e) {
    ...
    if ((typeof e == 'function' && (n = e), !this.options.resources || this.options.partialBundledLanguages)) {
      ...
      o ? a(o) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach((f) => a(f)),
        (s = (r = this.options.preload) == null ? void 0 : r.forEach) == null || s.call(r, (c) => a(c)),
  ...
  use(e) {
    ...
    return (
      ...
      e.type === 'postProcessor' && Hn.addPostProcessor(e),
    ...
    const r = (a) => {
      ...
      l = (a) => {
        ...
        c &&
          ...
          (u = (f = this.services.languageDetector) == null ? void 0 : f.cacheUserLanguage) == null || u.call(f, c)),
  ...
  getFixedT(e, t, n) {
    ...
    const r = function (s, l) {
      let a;
      if (typeof l != 'object') {
        for (var c = arguments.length, f = new Array(c > 2 ? c - 2 : 0), u = 2; u < c; u++) f[u - 2] = arguments[u];
      ...
      return (
        a.keyPrefix && Array.isArray(s)
          ? (b = s.map((h) => `${a.keyPrefix}${d}${h}`))
          : (b = a.keyPrefix ? `${a.keyPrefix}${d}${s}` : s),
        o.t(b, a)
      );
    };
  ...
  loadLanguages(e, t) {
    ...
    const o = this.options.preload || [],
      r = e.filter((s) => o.indexOf(s) < 0 && this.services.languageUtils.isSupportedCode(s));
    return r.length
    ...
    if (
      (e ||
        (e =
          ...
          (((o = this.languages) == null ? void 0 : o.length) > 0 ? this.languages[0] : this.language)),
      !e)
    )
      return 'rtl';
    const t = [
      ...
      n = ((r = this.services) == null ? void 0 : r.languageUtils) || new Ki(Gi());
  ...
  cloneInstance() {
    ...
    return (
      (r.translator = new ht(r.services, o)),
...
const Es = (i) => {
  const { notifications: e, language: t = 'fi' } = i,
    [n, o] = le(Ji(e)),
    [r, s] = le(() => e.filter((a) => !n.includes(Se(a))));
  return (
    J(() => {
    ...
    J(() => {
      const a = Ji(e);
      o(a), s(e.filter((c) => !a.includes(Se(c))));
    }, [e]),
    /* @__PURE__ */ ke(co, {
      i18n: Mt,
      children: /* @__PURE__ */ ke(rs, {
        notifications: r,
        onClose: (a) => {
          const c = Se(a);
          n.push(c), Mn(n), s(e.filter((f) => !n.includes(Se(f))));
        },
      }),
    })
  );
};
export { Es as NotificationService };
